...
define('AK_ROUTES_MAPPING_FILE',AK_TEST_DIR.DIRECTORY_SEPARATOR.'fixtures'.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'routes.php');
...
defined('AK_GENERATE_HELPER_FUNCTIONS_FOR_NAMED_ROUTES') ? null : define('AK_GENERATE_HELPER_FUNCTIONS_FOR_NAMED_ROUTES',false);
