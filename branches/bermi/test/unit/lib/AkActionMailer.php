...
Ak::import('render mailer');

class Tests_for_RenderHelper extends  AkUnitTest
{
    function setup()
    {
...
Ak::import('first_mailer,second_mailer');

class Tests_for_FirstSecondHelper extends  AkUnitTest
{
    function setup()
    {
        $this->Mailer =& new AkActionMailer();
...
Ak::test('Tests_for_RenderHelper');
Ak::test('Tests_for_FirstSecondHelper');


/** "Compiling the templates":http://akelos.org/api/1234 * /}?>
