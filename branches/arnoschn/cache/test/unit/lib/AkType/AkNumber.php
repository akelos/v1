...
class Test_AkNumber extends AkUnitTest
{
    ...
    function test_minutes_from_now()
    {
        $now = time();
    ...
    function test_seconds_from_now()
    {
        $now = time();
