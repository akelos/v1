...
Ak::import('parameter,category');

class Method extends ActiveRecord
{
    var $has_many = array('parameters');//,'examples', array('comments'=>array('condition'=>'is_published = 1')));
    var $belongs_to = array('akelos_class', 'category');
    var $acts_as = array('list' => array('scope'=>'akelos_class_id'));


    function &updateMethodDetails(&$Class, $method_name, $method_details, &$SourceAnalyzer)
    {
