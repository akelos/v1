...
class ActsAsMappable extends AkObserver
{
    ...
    # Bring distance query support into ActiveRecord models.  By default
    # uses 'miles' for distance units and performs calculations based upon the 
    # Haversine (sphere) formula.  These can be changed by setting 
#GeoKit::default_units and GeoKit::default_formula.  
    # Also, by default, uses lat, lng, and distance for respective
