...
class UserHelper extends AkActionViewHelper
{
    function cancel_link($url = array('action' => 'listing'))
    {
        ...
        if($this->_controller->Request->action == 'login'){
            $url = array('module' => '','controller' => 'page', 'action' => 'index');
        }
    ...
    {
        return '<input type="submit" value="'.$this->_controller->t('Save').'" class="primary" tabindex="25" />';
    }
