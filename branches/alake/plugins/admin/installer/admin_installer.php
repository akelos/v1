...
class AdminInstaller extends AkInstaller
{
    ...
    {
        $path = AK_CONFIG_DIR.DS.'config.php';
        $config = Ak::file_add_contents($path,'// $priority_countries are those which will appear at the top of the list of countries
// which may be selected in the add and edit pages of the user profile.
$GLOBALS['priority_countries'] = array('United States'=>'USA');
...
// "LOCALES" and "AK_AVAILABLE_LOCALES" should have the same number of entries.
define('LOCALES', 'English,Finnish,Swedish');
');
    }
